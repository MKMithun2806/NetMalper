...
- Run a scan with `--out scan.json`, then open [NetMalper Viewer](https://mkmithun2806.github.io/NetMalper/visualizer/netmalper_visualizer.html) or the legacy [NetMalper Vizualizer](http://threejs-rubiks-cube-mitch.s3-website.ap-south-2.amazonaws.com/) 
or use `--open-viewer`.
