...
```bash
wget -qO netmalper.deb "https://github.com/MKMithun2806/NetMalper/releases/download/Add-Amass/netmalper_3.0.0_all.deb" && sudo apt install ./netmalper.deb && rm netmalper.deb && NetMalper --help
```
