...
```bash
wget -qO netmalper.deb "https://github.com/MKMithun2806/NetMalper/releases/download/Stable-V1/netmalper_3.0.2_all.deb" && sudo apt install ./netmalper.deb && rm netmalper.deb && NetMalper --help
```
